    ...
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-6">
          ...
          <span>•</span>
          <span className="text-gray-900 font-medium">증시판</span>
        </nav>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-gray-600 mt-1">카테고리 3의 첫 번째 주요 항목에 대한 설명입니다.</p>
                </div>
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="font-medium text-gray-900">두 번째 항목</h3>
                  <p className="text-gray-600 mt-1">카테고리 3의 두 번째 주요 항목에 대한 설명입니다.</p>
                </div>
                <div className="border-l-4 border-purple-500 pl-4">
                  <h3 className="font-medium text-gray-900">세 번째 항목</h3>
                  <p className="text-gray-600 mt-1">카테고리 3의 세 번째 주요 항목에 대한 설명입니다.</p>
                </div>
              </div>
            </div>
