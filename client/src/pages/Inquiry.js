            ...
            <div className="bg-white rounded-lg shadow-sm border-2" style={{ borderColor: '#F5F5DC' }}>
              <div className="p-6">
                ...
                <div className="mt-8 p-4 bg-gray-50 rounded-lg">
                  <h3 className="text-lg font-semibold text-gray-800 mb-3">문의 전 확인사항</h3>
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li>• 자주 묻는 질문을 먼저 확인해 주세요</li>
                    <li>• 문의 내용은 구체적으로 작성해 주세요</li>
                    <li>• 답변은 1-2일 내에 이메일로 발송됩니다</li>
                    <li>• 긴급한 문의는 고객센터로 연락해 주세요</li>
                  </ul>
                </div>
              </div>
            </div>
