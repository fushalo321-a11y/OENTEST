        ...
        const mockVideos = [
          {
            id: 1,
            title: "드래곤타이거 기본 규칙",
            description: "드래곤타이거 게임의 기본적인 규칙과 플레이 방법을 배워보세요.",
          ...
          },
          {
            id: 2,
            title: "드래곤타이거 베팅 전략",
            description: "드래곤타이거에서 승률을 높이는 베팅 전략과 팁을 알아보세요.",
          ...
          },
          {
            id: 3,
            title: "드래곤타이거 라이브 게임",
            description: "라이브 딜러와 함께하는 드래곤타이거 게임의 실시간 매력을 체험해보세요.",
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-6">
          ...
          <span>•</span>
          <span className="text-gray-900 font-medium">드래곤타이거</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-10">
              ...
              <div className="bg-white rounded-lg shadow-sm border-2" style={{ borderColor: '#F5F5DC' }}>
                <div className="p-2 rounded-t-lg" style={{ backgroundColor: '#F5F5DC' }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center justify-center space-x-2 flex-1">
                      ...
                      <h3 className="text-gray-900 text-xs font-semibold">드래곤타이거 이벤트</h3>
                    </div>
                ...
                <div className="p-3">
                  <div className="space-y-2">
                    {[
                      { title: "드래곤타이거 챔피언십", points: "+120", date: "25.07.25" },
                      { title: "드래곤타이거 토너먼트", points: "+250", date: "25.07.03" },
                      { title: "드래곤타이거 리그", points: "+180", date: "25.06.23" },
                      { title: "드래곤타이거 배틀", points: "+90", date: "25.06.08" },
                      { title: "드래곤타이거 챌린지", points: "+150", date: "25.06.08" }
                    ].map((item, index) => (
          ...
          <div className="lg:col-span-3 order-2 lg:order-2">
            ...
            {!selectedVideo && (
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-4">드래곤타이거 영상 가이드</h2>
                {loading ? (
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">드래곤타이거 게임 정보</h2>
              <p className="text-gray-600 mb-4">
                드래곤타이거는 아시아에서 인기 있는 카드 게임으로, 드래곤과 타이거 중 어느 쪽이 이길지 예측하는 게임입니다. 
                빠른 진행과 높은 승률로 많은 플레이어들이 즐기는 게임입니다.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-medium text-gray-900 mb-2">드래곤타이거 기본 규칙</h4>
                  <p className="text-sm text-gray-600">드래곤과 타이거 중 어느 쪽이 높은 카드를 받을지 예측하는 간단한 규칙을 배워보세요.</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-medium text-gray-900 mb-2">드래곤타이거 베팅 전략</h4>
                  <p className="text-sm text-gray-600">드래곤, 타이거, 타이 베팅의 승률과 베팅 전략을 익혀보세요.</p>
                </div>
              </div>
            </div>
          </div>
