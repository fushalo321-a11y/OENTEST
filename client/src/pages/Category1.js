            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-gray-600 mt-1">카테고리 1의 첫 번째 주요 항목에 대한 설명입니다.</p>
                </div>
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="font-medium text-gray-900">두 번째 항목</h3>
                  <p className="text-gray-600 mt-1">카테고리 1의 두 번째 주요 항목에 대한 설명입니다.</p>
                </div>
                <div className="border-l-4 border-purple-500 pl-4">
                  <h3 className="font-medium text-gray-900">세 번째 항목</h3>
                  <p className="text-gray-600 mt-1">카테고리 1의 세 번째 주요 항목에 대한 설명입니다.</p>
                </div>
              </div>
            </div>
