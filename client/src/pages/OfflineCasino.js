    ...
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-6">
          ...
          <span>•</span>
          <span className="text-gray-900 font-medium">오프라인카지노</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-10">
          ...
          <div className="lg:col-span-3 order-2 lg:order-2">
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">오프라인카지노 콘텐츠</h2>
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-medium text-gray-900">오프라인카지노 첫 번째 항목</h3>
                  <p className="text-gray-600 mt-1">오프라인카지노의 첫 번째 주요 항목에 대한 설명입니다.</p>
                </div>
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="font-medium text-gray-900">오프라인카지노 두 번째 항목</h3>
                  <p className="text-gray-600 mt-1">오프라인카지노의 두 번째 주요 항목에 대한 설명입니다.</p>
                </div>
                <div className="border-l-4 border-purple-500 pl-4">
                  <h3 className="font-medium text-gray-900">오프라인카지노 세 번째 항목</h3>
                  <p className="text-gray-600 mt-1">오프라인카지노의 세 번째 주요 항목에 대한 설명입니다.</p>
                </div>
              </div>
            </div>

            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">오프라인카지노 정보</h2>
              <p className="text-gray-600 mb-4">
                오프라인카지노에 대한 추가적인 정보와 설명을 제공합니다. 
                이 섹션에서는 더 자세한 내용을 확인할 수 있습니다.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-medium text-gray-900 mb-2">오프라인카지노 특징 1</h4>
                  <p className="text-sm text-gray-600">오프라인카지노의 첫 번째 특징에 대한 설명</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-medium text-gray-900 mb-2">오프라인카지노 특징 2</h4>
                  <p className="text-sm text-gray-600">오프라인카지노의 두 번째 특징에 대한 설명</p>
                </div>
              </div>
            </div>
          </div>
